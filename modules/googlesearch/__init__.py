...
# Setup file logging.
log_file_handler = logging.FileHandler("googlesearch.py.log")
...
class SearchClient:
    def __init__(
        ...
        user_agent=None,
        googlesearch_manages_http_429s=True,
        ...
        :param bool googlesearch_manages_http_429s: Determines if googlesearch will handle HTTP 429 cool off and
        ...
        self.googlesearch_manages_http_429s = googlesearch_manages_http_429s
    ...
    def get_page(self, url):
        ...
        if http_response_code == 200:
            ...
            # Calling script does not want googlesearch to handle HTTP 429 cool off and retry.  Just return a
            # notification string.
            if not self.googlesearch_manages_http_429s:
                ROOT_LOGGER.info("Since googlesearch_manages_http_429s=False, googlesearch is done.")
                ...
                if link not in self.search_result_list:
                    ...
                    if self.verbose_output:
                        self.search_result_list.append(
                            {
                                "rank": total_valid_links_found,  # Approximate rank according to googlesearch.
